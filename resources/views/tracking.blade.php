...
<html lang>
    <head>
        ...
        <title>Tracking | Fleetlink</title>
        <!-- Fonts -->
    ...
    <style>
        .active {
            background-color: #60a5fa; /* Change to your desired active background color */
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-3 z-40 w-60 h-screen  pt-20 transition-transform -translate-x-full border-white-200 sm:translate-x-0 dark:bg-white-800 dark:border-white-700" aria-label="Sidebar">
     <div class="h-15 min-h-0 md:min-h-full pb-4 overflow-y-auto rounded-2xl bg-blue dark:bg-blue-200">
        <ul class=" mt-10 px-none font-large">
           ...
           <li>
            <a href="#" class="flex items-center p-2 text-gray-900  dark:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-blue-400 group active">
                  <svg class="flex-shrink-0 w-7 h-8 ms-8 text-gray-500 transition duration-75 dark:text-blue-700 group-hover:text-gray-900 dark:group-hover:text-white active" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
           ...
           <li>
            <a href="message" class="flex items-center p-2 text-gray-900 dark:text-black dark:hover:text-white hover:bg-blue-100 dark:hover:bg-blue-400 group">
                <svg class="flex-shrink-0 w-7 h-7 ms-8 text-gray-500 transition duration-75 dark:text-blue-700 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
<body>
    <div class="p-7 sm:ml-64">
        <div class="p-4 w-[20rem] h-[40rem] rounded-2xl bg-blue dark:bg-neutral-100 mt-14">
    <div class="relative ">
        <div class="absolute inset-y-0 left-0 mt-3 flex  pl-2 pointer-events-none">
            <svg class="w-4 h-5 ml-3 text-blue-700 dark:text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
            </svg>
        </div>
        <input type="search" id="default-search" class="block w-full ml-0 mt-2 p-1 pl-20 text-xl text-gray-900 border border-neutral-500 rounded-full bg-neutral-200 focus:ring-blue-500 focus:border-nuetral-200 dark:bg-neutral-200 dark:border-neutral-200 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required>
        <div>
            <ul>
                <li class="">
                    <a href="#" class="flex  mt-6 w-full px-3 py-3 hover:bg-blue-50 dark:hover:bg-blue-800">
                     <img class="mr-3 mt-3 rounded-full w-11 h-11" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
                        <div>
                         <span class="font-medium text-white-900 dark:text-black hover:text-white-800 dark:hover:text-white-800">PX - 7</span>
                            <p class="text-sm text-gray-500 dark:text-black-400">Kurt Axel Nanalis</p>
                            <p class="text-sm text-gray-500 dark:text-black-400">Honda</p>
                        </div>
                    </a>
                </li>
                <li class="">
                    <a href="#" class="flex w-full px-4 py-3 hover:bg-blue-50 dark:hover:bg-gray-800">
                     <img class="mr-3 rounded-full w-11 h-11" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
                     <div>
                        <span class="font-medium text-white-900 dark:text-black hover:text-white-800 dark:hover:text-white-800">PCF 872</span>
                        <p class="text-sm text-gray-500 dark:text-black-400">Karl Lewis Doctolero</p>
                        <p class="text-sm text-gray-500 dark:text-black-400">Honda</p>
                        </div>
                    </a>
                </li>
...
<script>
    // Determine the active page or route (replace this with your actual logic)
    var currentPage = window.location.pathname;

    // Get all navigation links
    var navLinks = document.querySelectorAll('#logo-sidebar a');

    // Loop through the links and add the "active" class to the appropriate one
