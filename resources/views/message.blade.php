  ...
  <aside id="logo-sidebar" class="fixed top-0 left-3 z-40 w-60 h-screen  pt-20 transition-transform -translate-x-full border-white-200 sm:translate-x-0 dark:bg-white-800 dark:border-white-700" aria-label="Sidebar">
     <div class="h-15 min-h-0 md:min-h-full pb-4 overflow-y-auto rounded-2xl bg-blue dark:bg-blue-200">
        <ul class=" mt-10 px-none font-large">
           ...
           <li>
            <a href="#" class="flex items-center p-2 text-gray-900 dark:text-black dark:hover:text-white hover:bg-blue-100 dark:hover:bg-blue-400 group active">
                <svg class="flex-shrink-0 w-7 h-7 ms-8 text-gray-500 transition duration-75 dark:text-blue-700 group-hover:text-gray-900 dark:group-hover:text-white active" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
