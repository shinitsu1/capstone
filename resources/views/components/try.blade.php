...
<nav class="pt-20 fixed">
    <div class="bg-blue-200 absolute left-3 w-60 h-full rounded-2xl">
        <ul class="mt-2" >
            <li class="mb-1 group active">
                <a href="{{ asset('dashboard')}}" class="flex items-center py-2 px-4 text-black hover:bg-blue-700 hover:text-gray-100 rounded-md group-[.active]:bg-blue-800 group-[.active]:text-white group-[.selected]:bg-[#4ECE5D] group-[.selected]:text-white">
