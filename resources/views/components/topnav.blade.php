@include('partials.header')
    ...
    <nav class="flex-2">
        <div name="nav-links" class="flex-1 items-center justify-between">
            <ul name="nav-link" class="flex flex-col md:flex-row px-4 ">
                <li>
                    <a href="" class="block py-2 pr-4 pl-3">Vehicles</a>
                </li>
                <li>
                    <a href="" class="block py-2 pr-4 pl-3">Register</a>
                </li>
                <li>
                     <form action="/logout" method="POST">
                        @csrf
                        <button class="block py-2 pr-4 pl-3 bg-blue-700 mx-[10px]">Logout</a>
                     </form>
                </li>
            </ul>
        </div>
